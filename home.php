...
if ($result->num_rows > 0) {
  ...
  echo("<table border=1 align=center>
    <tr>
    <form action='emp_ed.php'>
    <td colspan=3><input type=text placeholder='Enter user Id to Edit/Delete' name='emp_id'></td> <td><input type=submit value='Delete/Edit'></td>
    </form>
    </tr>
...
echo "
<a href='/ayeakka/emp_add.php' class=button>Add Employer</a>
<a href='/ayeakka/dpt.php' class=button>Departments</a>
